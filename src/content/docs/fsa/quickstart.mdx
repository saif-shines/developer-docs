...
<Card title="Generate FSA Code with AI in Minutes" icon="seti:vite" style="background-color: white !important;">
...
2. ## Redirect users to hosted login page
       Generate the authorization URL by passing a [registered callback URL](/guides/dashboard/redirects/#allowed-callback-urls) and scopes to the Scalekit SDK.
        <Tabs syncKey="tech-stack">
